...
def render_uv1(ctx, mesh, resolution, mlp_texture, uv_padding_block, ks_vals):
    ...
    print(f'[INFO] UV padding for RoughnessMetalness...')
    rm = uv_padding(all_tex, hole_mask, uv_padding_block)
     
    return (rast[..., -1:] > 0).float(), rm